...
namespace Mithril
{
	...
	public sealed class Json : object
	{
		...
		public static object Decode(in string data) =>
			new Json().DecodeAny(typeof(object), data);
		public static object Decode(Type type, in string data) =>
			new Json().DecodeAny(type, data);
		public static T Decode<T>(in string data) =>
			(T)new Json().DecodeAny(typeof(T), data);

		public static string Encode(in object obj) =>
			new Json().EncodeAny(obj);
	...
	public static class TranslatorExtensions
	{
		...
		private static bool IsSerializableField(this FieldInfo field)
		{
			return
				...
				(field.IsPublic || field.GetCustomAttribute<MirrorFieldAttribute>() != null)
			;
		}

		private static bool ShouldGetBaseFields(this Type type) =>
			typeof(object) != type;
		...
		public static FieldInfo GetSerializableField(this Type type, string name)
		{
			...
			if (__result == null && type.ShouldGetBaseFields())
